...
public class OverflowAreaUtils {
    ...
    public static let TableOfOverflowServiceUuidStringsByBitPosition = [
        "00000000-0000-0000-0000-00000000007C", //0
        ...
        "00000000-0000-0000-0000-000000000024", //10
        ...
        "00000000-0000-0000-0000-000000000049", //20
        ...
        "00000000-0000-0000-0000-000000000011", //30
        ...
        "00000000-0000-0000-0000-000000000017", //40
        ...
        "00000000-0000-0000-0000-00000000005F", //50
        ...
        "00000000-0000-0000-0000-000000000022", //60
        ...
        "00000000-0000-0000-0000-000000000009", //70
        ...
        "00000000-0000-0000-0000-00000000002E", //80
        ...
        "00000000-0000-0000-0000-000000000076", //90
        ...
        "00000000-0000-0000-0000-00000000003A", //100
        ...
        "00000000-0000-0000-0000-000000000062", //110
        ...
        "00000000-0000-0000-0000-000000000045", //120
        ...
        "00000000-0000-0000-0000-000000000039"  //127
    ]
    ...
    public static func allOverflowServiceUuids() -> [CBUUID] {
        //print("TableOfOverflowServiceUuidsByBitPosition:", TableOfOverflowServiceUuidsByBitPosition)
        //print("count:", TableOfOverflowServiceUuidsByBitPosition.count)
    ...
    public static func overflowServiceUuidsToBytes(overflowUuids: [CBUUID]) -> [UInt8] {
        var bytes: [UInt8] = []
        var bitPositions: [Int] = []
        print("overflowUuids: ", overflowUuids)
        for uuid in overflowUuids {
        ...
        _ = bitsToPacketBytes(onBits: bitPositions)
    ...
    public static func bitsToPacketBytes(onBits: [Int]) -> [String] {
        var bytes: [UInt8] = []
        var hexstr: [String] = []
        var index = 0
        for byteNumber in 0...15 {
            ...
            for bitNumber in 0...7 {
                let bitPosition = byteNumber*8+bitNumber
                if index < onBits.count && onBits[index] == bitPosition {
                    byte = byte + UInt8(pow(Double(2), Double(7-bitNumber)))
                    index = index + 1
                }
            }
            bytes.append(byte)
            hexstr.append(String(byte, radix:16))
        }
        print("packet bytes:", hexstr)
        return hexstr
    }
    ...
    public static func bitsToOverflowServiceUuids(bits: [UInt8]) -> [CBUUID] {
        ...
        var cbUuids: [CBUUID] = []
        print("bits:", bits, " count:", bits.count)
        ...
        print("---cbUiids:", cbUuids, " count:", cbUuids.count)
        return cbUuids
    }
